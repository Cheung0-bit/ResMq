        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "index">active</#if>"><a href="${request.contextPath}/"><i
                                class="fa fa-circle-o text-aqua"></i><span>运行报表</span></a></li>
                <li class="nav-click <#if pageName == "topic">active</#if>"><a href="${request.contextPath}/topic"><i
                                class="fa fa-circle-o text-yellow"></i><span>消息主题</span></a></li>
